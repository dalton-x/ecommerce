...
@section('main')
    <main class="container mx-auto">
        <h1 class="mb-3 text-2xl font-bold">Mettre à jour {{ $product->name }}</h1>

        <form class="flex flex-wrap" action="{{ url('/product/update/'.$product->id) }}" method="POST"  enctype="multipart/form-data">
            ...
            <div class="flex flex-col w-1/2 p-1">
                ...
                <select type="number" name="vat" step="0.01" value="{{ old("vat",$product->vat) }}"
            ...
            <div class="mt-5">
                <button class="px-4 py-2 text-center text-white bg-blue-800" type="submit">Mettre à jour ce produit</button>
            </div>
